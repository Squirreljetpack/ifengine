...
The frontend dispatches all 9 [`Object`](file:///Users/absinthe/gh/OWN/ifengine/ifengine_core/src/view/mod.rs) variants defined in `ifengine_core::view::Object` via [`ObjectView`](file:///Users/absinthe/gh/OWN/ifengine/leptos/src/components/object.rs):

| `Object` Variant | DOM Tag / Component | Features & CSS Classes |
| :--- | :--- | :--- |
| [`Object::Paragraph`](file:///Users/absinthe/gh/OWN/ifengine/ifengine_core/src/view/mod.rs) | `<p class="passage-paragraph">` | Standard book paragraph rhythm (1.35rem top margin, word break). Collapses margins to `0` when child elements are empty or pending entrance delay. Carries optional `RenderData`: `":speaker"` renders as dialogue (`.passage-dialogue` with a left-aligned `<span class="dialogue-speaker">speaker</span>`), `"m-{val}"` / `"mt-{val}"` (e.g. `"m-0"`, `"mt-1.5"`) overrides inline margin to `margin-top: 0;` (or `{val}rem`), `"choice"` renders with tight choice y-spacing (`margin-top: 0.6rem; line-height: 1.6;` on `[data-render="choice"]`), and `"popup"`/`"modal"` wraps the paragraph in a modal dialog. |
| [`Object::Heading`](file:///Users/absinthe/gh/OWN/ifengine/ifengine_core/src/view/mod.rs) | `<h1..h6 class="passage-heading h{level}">` | Serif headings with scaled vertical margins (`h1`=2.1rem / mt 2.2rem mb 1.4rem, `h2`=1.7rem / mt 1.9rem mb 1.1rem, `h3`=1.4rem uppercase / mt 1.6rem mb 0.9rem, `h4`=1.2rem / mt 1.4rem mb 0.7rem, `h5`=1.05rem / mt 1.2rem mb 0.5rem, `h6`=0.95rem / mt 1.1rem mb 0.4rem). |
