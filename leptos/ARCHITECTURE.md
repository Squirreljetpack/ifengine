...
| [`Object::Text`](file:///Users/absinthe/gh/OWN/ifengine/ifengine_core/src/view/mod.rs) | `<div class="passage-text" data-render="...">` | Zero margins (`margin: 0`) for unspaced plain text flow. Emits raw `data-render` attribute on DOM node. When `data-render` is `"popup"` (or `"modal"`), wraps text in `.passage-popup-backdrop` and `.passage-popup-dialog` without built-in close buttons. |
