                ...
                ui.horizontal_centered_labels(self.header(), |ui| {
                    ui.vertical(|ui| {
                        ...
                        ui.add_menu(hovered, light, |ui| {
                            ...
                            style.spacing.item_spacing = MENU_SPACING;
            ...
            .show(ctx, |ui| {
                center_vertical(ui, |ui| {
                    ui.vertical_centered_justified(|ui| {
                        ...
                        ui.set_width(width);
                        // let top = if panel_eq_window_fill(ui) { 10 } else { 20 };
                        let top = 10;
                        let left = 5;
                        egui::Frame::new()
                            ...
                            .show(ui, |ui| {
                                ...
                                let middle_id = ui.make_persistent_id("middle_transition");
                                if ui
                                    .ctx()
                                    .data_mut(|d| d.remove_temp::<()>(middle_id))
                                    .is_some()
                                {
...
pub fn panel_eq_window_fill(ui: &egui::Ui) -> bool {
    let style = ui.style();

    let panel_color = style.visuals.panel_fill;

    let window_color = style.visuals.window_fill;

    panel_color == window_color
}
